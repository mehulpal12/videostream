  ...
  return (
          ...
          <div className="relative z-10 space-y-6 px-4">
            ...
            <div className="flex flex-wrap gap-3 justify-center pt-4">
              {categories.map(cat => (
                <button key={cat} className="px-5 py-2.5 bg-white/10 backdrop-blur-xl border border-white/10 rounded-full text-sm font-medium hover:bg-white/20 transition-all">
                  {cat}
                </button>
              ))}
            </div>
